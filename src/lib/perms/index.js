var acllib = require('acl'),
    ...
    perms_db_uri = require('../../perms_db'),
    moment = require('moment');

var acl = new acllib(new acllib.memoryBackend());
...
var perms = {
    ...
    addFreeTopicRolePerms: function(topic, callback) {
        ...
        acl.allow([{
            ...
            allows:[
                {resources: '' + self.getKey(topic), permissions: [constants.VIEW_PERMS, constants.EDIT_PERMS, constants.ADD_PERMS]}
            ]
        },
        {
        ...
        },
        {
            ...
            allows:[
                {resources: '' + self.getKey(topic), permissions: [constants.VIEW_PERMS, constants.ADD_PERMS, constants.EDIT_PERMS]}
            ]
        },
        {
            roles: constants.TOPIC_ADMIN_ROLE + self.getKey(topic),
            allows:[
                {resources: '' + self.getKey(topic), permissions: [constants.VIEW_PERMS, constants.ADD_PERMS, constants.EDIT_PERMS, constants.DELETE_PERMS]}
            ]
        },
        {
