...
describe('User', function() {
	...
	describe('when created', function() {
		it('should be created properly', function(done){
			User.create(null, userData.name, userData.password, userData.email, null, function(error,userId){
		...
		it('should have a valid email', function() {
			assert.throws(
				User.create(null, userData.name, userData.password, 'fakeMail', null, function(){}),
				Error,
