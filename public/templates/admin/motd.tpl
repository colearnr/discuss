...
<div class="alert alert-warning motd">
	<p>
		...
		In discuss, the MOTD is present at the top of the forum homepage, and can be customized much like a header.
	</p>
	<p>
		You can enter either full HTML or Markdown text.
	</p>
	<br />
	<textarea class="form-control" placeholder="Welcome to discuss!" data-field="motd" rows="10"></textarea>
	<br />
