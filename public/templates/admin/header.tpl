...
<html>
<head>
	<title>discuss Administration Panel</title>
	...
	<script type="text/javascript" src="{cdn_prefix}/vendor/jquery/js/jquery.js"></script>
	<script type="text/javascript" src="{relative_path}/vendor/bootstrap/js/bootstrap.min.js"></script>
	<script type="text/javascript" src="{cdn_prefix}/vendor/jquery/js/qunit-git.js"></script>
	<link rel="stylesheet" type="text/css" href="{cdn_prefix}/vendor/jquery/css/qunit-git.css">
	...
	<script type="text/javascript" src="{cdn_prefix}/vendor/jquery/js/jquery-ui.min.js"></script>
	<script src="{relative_path}/src/utils.js"></script>

	<link rel="stylesheet" type="text/css" href="{relative_path}/css/discuss.css" />
	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="/admin/index">discuss ACP</a>
			</div>
			<div class="collapse navbar-collapse">
				<ul class="nav navbar-nav">
					<li>
					  <a href="/" target="_blank"><i class="fa fa-book"></i> Forum</a>
					</li>
					<li>
			...
			<div class="col-md-3">
				<div class="well sidebar-nav">
					<ul class="nav nav-list">
						<li class="nav-header">discuss</li>
						<li class='active'><a href='{relative_path}/admin/index'><i class='fa fa-home'></i> Home</a></li>
						<li class=''><a href='{relative_path}/admin/categories/active'><i class='fa fa-folder-close-o'></i> Categories</a></li>
