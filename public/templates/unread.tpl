						...
						<small>
							...
							<span>
								<a href="/user/{topics.userslug}">
									<img class="img-circle teaser-pic" src="{topics.picture}" title="{topics.username}"/>
								</a>
								posted in
							...
							<span class="pull-right hidden-xs">
								<a href="/user/{topics.teaser_userslug}">
									<img class="img-circle teaser-pic" src="{topics.teaser_userpicture}" title="{topics.teaser_username}"/>
								</a>
