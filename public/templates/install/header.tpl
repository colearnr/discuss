...
<head>
	...
	<meta name="title" CONTENT="discuss">
...
<body>
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="navbar-inner">
			<div class="container">
				<a class="brand" href="/install">discuss Installation</a>
				...
				<div class="nav-collapse collapse">
					<ul class="nav discuss-inline-block">
						<li>
						...
						<li>
							<a data-tab="privileges" href="/install/privileges"><i class="fa fa-legal"></i> Privileges</a>
						</li>
					</ul>
				</div>
			</div>
