...
<form class="form-inline">
	...
	<p>
		Please enter the web-accessible url that will be used to point to the discuss installation. If you are using a port number in the address,
