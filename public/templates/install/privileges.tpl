...
<div class="pull-right">
	<button id="start-discuss" class="btn btn-success btn-lg"><i class="icon-thumbs-up"></i> Start using discuss!</button>
</div>
<div>
...
<script>
	(function() {
		...
		var startEl = document.getElementById('start-discuss');
