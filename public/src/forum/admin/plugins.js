var discuss_admin = discuss_admin || {};
...
(function() {
			...
			if (numPlugins > 0) {
				...
				socket.on('api:admin.plugins.toggle', function(status) {
					...
					app.alert({
						...
						message: 'You may need to restart discuss in order for these changes to be reflected.',
						type: 'warning',
						timeout: 5000
					})
				});
	...
	jQuery(document).ready(function() {
		discuss_admin.plugins = plugins;
		discuss_admin.plugins.init();
	});
})();
