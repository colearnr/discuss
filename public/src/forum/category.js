	...
	Category.init = function() {
		...
		socket.on('api:categories.getRecentReplies', function (posts) {
			...
			for (var i = 0, numPosts = posts.length; i < numPosts; i++) {
				...
				li.innerHTML = '<a href="/user/' + posts[i].userslug + '"><img title="' + posts[i].username + '" style="width: 48px; height: 48px; /*temporary*/" class="img-circle" src="' + posts[i].picture + '" class="" /></a>' +
